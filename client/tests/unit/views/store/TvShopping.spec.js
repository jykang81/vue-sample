...
// // import temp03ReqNSFixedShopCmd from '@unit/views/store/mock/03_req_NSFixedShopCmd'
// import temp03ResNSFixedShopCmd from '@unit/views/store/mock/03_res_NSFixedShopCmd'
...
//     .reply(200, temp03ResNSFixedShopCmd)
...
//     tvShoppingWrapper = mount(TvShopping, options)
...
//     // await flushPromises()
//   })
//   describe('TvShopping 테스트', () => {
//     it('onCollapse', async () => {
//       const wrapper = tvShoppingWrapper.find(TvShopping)
