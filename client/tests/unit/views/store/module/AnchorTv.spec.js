...
describe('AnchorTv test case', () => {
  ...
  before('before', function () {
      ...
      espotData: {
        espotList: {
          _EZ_HOME_ANCHOR2A_ESPOT_CNTNTPROM:
            secondResponse.msg.espotList[0]._EZ_HOME_ANCHOR2A_ESPOT_CNTNTPROM,
          _EZ_HOME_ANCHOR2B_ESPOT_PRDWIDE:
            secondResponse.msg.espotList[1]._EZ_HOME_ANCHOR2B_ESPOT_PRDWIDE
        },
        espotExtendList: {
          _EZ_HOME_ANCHOR2A_ESPOT_CNTNTPROM:
            secondResponse.msg.espotExtendList._EZ_HOME_ANCHOR2A_ESPOT_CNTNTPROM,
          _EZ_HOME_ANCHOR2B_ESPOT_PRDWIDE:
            secondResponse.msg.espotExtendList._EZ_HOME_ANCHOR2B_ESPOT_PRDWIDE
        }
      }
    }
    options = {
    ...
    wrapper = shallowMount(AnchorTv, options)
  })
