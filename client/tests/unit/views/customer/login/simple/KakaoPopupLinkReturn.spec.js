...
import kakaoPopupLinkReturn from '@/views/customer/login/simple/KakaoPopupLinkReturn'
import Vue from 'vue'
...
describe('KakaoPopupLinkReturn', () => {
  ...
  beforeEach(function () {
    ...
    wrapper = mount(kakaoPopupLinkReturn, options)
  })
