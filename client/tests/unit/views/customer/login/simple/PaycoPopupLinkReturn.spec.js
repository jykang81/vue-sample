...
import paycoPopupLinkReturn from '@/views/customer/login/simple/PaycoPopupLinkReturn'
import Vue from 'vue'
...
describe('PaycoPopupLinkReturn', () => {
  ...
  beforeEach(function () {
    ...
    wrapper = mount(paycoPopupLinkReturn, options)
  })
  ...
  it('url정보 취득 ', () => {
    ...
    // @ts-ignore
    window.location = new URL('https://local.nsmall.com:3000/customer/login/simple/payco?code=WSOqQpllTeeu7CQkWp3excmp&state=821_http')
