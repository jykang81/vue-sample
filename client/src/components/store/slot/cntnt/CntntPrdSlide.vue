<template>
  <!-- 배너 프로모션형 슬롯 -->
  <section :id="espotName" class="cntnt_prd_slide">
    <div
      class="category_top"
...
export default {
  ...
  methods: {
    ...
    espotDraw () {
      ...
      if (this.espotData[this.getId][0].prdList.length > 20) {
        for (let i = 0; i < 20; i++) {
...
<style lang="scss">
  @import "~@/assets/styles/components/store/slot/cntnt/CntntPrdSlide";
</style>
