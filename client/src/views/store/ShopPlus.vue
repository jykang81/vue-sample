      ...
      >
        ...
        >
          <div
            ...
            @click="recomProductDetailLogging (prdRecommend, { clksrc: 'Shop+_추천방송상품'})"
          >
            <figure>
              <ns-img
                ...
                :width="320"
                :height="320"
                :alt="htmlDecode(prdRecommend.itncatentrynm)"
        ...
        >
          ...
          >
            ...
            >
              <ns-img
                :src="benefit.imgUrl"
                :alt="htmlDecode(benefit.slotTitle)"
              />
              <p class="label">
    ...
    <section class="tv_shopping_next">
      ...
      >
        ...
        <div class="product_box">
          <div
            class="product"
            @click="nextProductDetailLogging(nextTvSchedule, { clksrc: 'Shop+_다음방송상품' })"
          >
            <figure>
              <ns-img
      ...
      />
      <!-- TV쇼핑 인기 프로그램 -->
      <div v-if="topProgramList.length > 0" class="popular_program" :name="espotKeyName3">
        <div class="title_tag">
          <p class="title">
            {{ htmlDecode(title4) }}
          </p>
        ...
        <div class="program_box">
          ...
          >
            <div
              class="program"
              @click="popularProgramProductDetail(
                topProgram.clickTarget,
                topProgram.contentsId,
                topProgram.clickCode,
                topProgram.espotId,
                topProgram.mdUrl,
                topProgram.slotTitle
              )"
            >
              <dt>
                <ns-img
          ...
          <div class="benefit_button">
            ...
            <div class="btn_group">
              <button
                ...
                type="button"
                class="btn_buy"
                @click="layerOpen('2', nextTvScheduleIdx2, '', 'N', nextTvSchedule2.goodsName)"
              >
                바로구매
              </button>
              <button
        ...
        >
          <div
            ...
            @click="preRecommendProductDetail(
              ...
              { clksrc: `Shop+_${title2.replace(/\s/g, '')}_인기방송상품` },
              title2,
        ...
        >
          <div
            ...
            @click="preRecommendProductDetail(
              ...
              { clksrc: `Shop+_${title3.replace(/\s/g, '')}_인기방송상품` },
              title3,
...
export default {
  ...
  created () {
    ...
    marketingUtil.airbridgeLogger.send({
      event: marketingUtil.airbridgeLogger.EVENT.ITEM_SHOP, // 편성매장 - Shop+
      data: {
        action: '편집매장',
        label: '편집매장 조회',
        categoryNm: 'tcshopping'
      }
    })
  },
  async mounted () {
  ...
  methods: {
      ...
      marketingUtil.ga360Logger.send({
        ...
        data: {
          ...
          subparams: {
            ...
            t2: title,
            t3: '인기방송상품',
            product_list: `Shop+_${title}_인기방송상품`
          }
        }
      })
     ...
     * @param {string} title 제목
     */
    popularProgramProductDetail (clickTarget, contentsId, clickCode, espotId, mdUrl, title) {
      // 마케팅 스크립트 적용 부분
      // GA360
      marketingUtil.ga360Logger.send({
        type: marketingUtil.ga360Logger.LOG_EVENT,
        data: {
          eventCate: 'MOBILE_NSShop+',
          eventAction: '인기프로그램',
          eventLabel: htmlDecode(title.split('|')[0]),
          params: {
            t1: null
          }
        }
      ...
      marketingUtil.ga360Logger.send({
        ...
        data: {
          ...
          subparams: {
            t1: 'Shop+',
            t2: '인기프로그램',
            product_list: 'Shop+_인기프로그램'
          }
        }
      })

      bizUtil.espotClickEvent(clickTarget, contentsId, clickCode, espotId, mdUrl, null, 'Shop+_인기프로그램')
    },
    /**
     * 다음방송상품 상세 보기 클릭
     * @param {Object} productInfo 상품데이터
     * @param {string} clksrc 전자상거래코드
     */
      ...
      marketingUtil.ga360Logger.send({
        ...
        data: {
          ...
          subparams: {
            t1: 'Shop+',
            t2: '중간배너',
            product_list: 'Shop+_중간배너'
          }
        }
      })

      bizUtil.espotClickEvent(clickTarget, contentsId, clickCode, espotId, mdUrl, null, 'Shop+_중간배너')
    },
    /**
     * 혜택 클릭
     * @param {string} clickTarget 이동할 타겟 구분(Product, Category, Internal, External)
    ...
    async callNsEspotMain () {
      const param = {
        ...
        espotInfo: 'EZ_CTCOM_RCMD1|ESPOT_PRDSLIDESQUARE25W|1|9999|0$EZ_CTCOM_RCMD2|ESPOT_PRDSLIDESQUARE25W|1|9999|0$EZ_CTCOM_RCMD3|ESPOT_PRDSLIDESQUARE25W|1|9999|0$EZ_CTCOM_BNFT|ESPOT_CNTNT4W|1|4|0$EZ_CTCOM_BANNER|ESPOT_CNTNTLIST|1|2|0$EZ_CTCOM_PROGRAM|ESPOT_CNTNT2W|1|9999|0'
      }

      const successHandling = data => {
        this.espotKeyName1 = '_EZ_CTCOM_RCMD1'
        this.espotKeyName5 = '_EZ_CTCOM_RCMD2'
        this.espotKeyName6 = '_EZ_CTCOM_RCMD3'
        this.espotKeyName3 = '_EZ_CTCOM_PROGRAM'

        this.title1 = !isNull(data.msg.espotExtendList._EZ_CTCOM_RCMD1) ? data.msg.espotExtendList._EZ_CTCOM_RCMD1.titleContent.mainTitle : ''
        this.title2 = !isNull(data.msg.espotExtendList._EZ_CTCOM_RCMD2) ? data.msg.espotExtendList._EZ_CTCOM_RCMD2.titleContent.mainTitle : ''
        this.title3 = !isNull(data.msg.espotExtendList._EZ_CTCOM_RCMD3) ? data.msg.espotExtendList._EZ_CTCOM_RCMD3.titleContent.mainTitle : ''
        this.title4 = !isNull(data.msg.espotExtendList._EZ_CTCOM_PROGRAM) ? data.msg.espotExtendList._EZ_CTCOM_PROGRAM.titleContent.mainTitle : ''

        for (let i = 0; i < data.msg.espotList.length; i++) {
          // 추천 방송상품
          if (!isNull(data.msg.espotList[i]._EZ_CTCOM_RCMD1)) {
            this.prdRecommendList = data.msg.espotList[i]._EZ_CTCOM_RCMD1
          }
          // 홈&리빙 방송상품
          if (!isNull(data.msg.espotList[i]._EZ_CTCOM_RCMD2)) {
            this.prdRecommendList2 = data.msg.espotList[i]._EZ_CTCOM_RCMD2
          }
          // 패&뷰 방송상품
          if (!isNull(data.msg.espotList[i]._EZ_CTCOM_RCMD3)) {
            this.prdRecommendList3 = data.msg.espotList[i]._EZ_CTCOM_RCMD3
          }
          // 혜택
          if (!isNull(data.msg.espotList[i]._EZ_CTCOM_BNFT)) {
            this.benefitList = data.msg.espotList[i]._EZ_CTCOM_BNFT
          }
          // 프로모션 띠배너
          if (!isNull(data.msg.espotList[i]._EZ_CTCOM_BANNER)) {
            this.promotionBannerList = data.msg.espotList[i]._EZ_CTCOM_BANNER
          }
          // 인기프로그램
          if (!isNull(data.msg.espotList[i]._EZ_CTCOM_PROGRAM)) {
            this.topProgramList = data.msg.espotList[i]._EZ_CTCOM_PROGRAM
          }
        }
      }
    ...
    async callTvScheduleList () {
      const param = {
        typeFlag: 'espot',
        espotInfo: 'EZ_CTCOM_BROAD|CTCOMSCHEDULE24_NONE|1|9999|0'
      }
    ...
    callBackTvScheduleList (data) {
      this.espotKeyName2 = '_EZ_CTCOM_BROAD'
      this.espotKeyName4 = '_EZ_CTCOM_BROAD'

      let tmpTvScheduleList = []
      let tmpIdx = 0
      for (let i = 0; i < data.msg.length; i++) {
        if (!isNull(data.msg[i]._EZ_CTCOM_BROAD)) {
          tmpTvScheduleList = data.msg[i]._EZ_CTCOM_BROAD[0].cTcomSchedule.TotalOrgan
        }
      }
